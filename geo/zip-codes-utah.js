...
@media(max-width:640px){
  ...
  el.innerHTML = `<div class="rsa-ix-wrap"><div class="rsa-ix-header"><h1>Medicare ZIP Codes in Utah</h1><p>Every ZIP code in Utah has its own Medicare plan options, doctor networks, and local resources.
     Find your ZIP below — or browse by region using the prefix groups.</p></div><div class="rsa-ix-container">
  <div class="stats-row">
