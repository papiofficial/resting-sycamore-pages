...
@media(max-width:640px){
  ...
  el.innerHTML = `<div class="rsa-ix-wrap"><div class="rsa-ix-header"><h1>Medicare by County in Pennsylvania</h1><p>Medicare plan availability, doctor networks, and coverage options all vary by county. Browse all 67 Pennsylvania counties to find plans and resources near you.</p></div><div class="rsa-ix-container">
  <div class="stats-row">
