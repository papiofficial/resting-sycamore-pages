(function(){
  var el = document.getElementById('rsa-state-utah');
  if (!el) return;
  ...
  <div class="rsa-ix-hero">
    <div class="rsa-ix-breadcrumb">
      ...
      <span>›</span>
      <span class="rsa-ix-bc-current">Utah</span>
    </div>
    <h1>Medicare in Utah</h1>
    <p>Compare Medicare Advantage plans, find in-network doctors and care facilities, and explore coverage options across all 29 Utah counties.</p>
  </div>
  <div class="rsa-ix-content">

    <div class="rsa-ix-stats">
      <div class="rsa-ix-stat"><div class="num">73</div><div class="lbl">Plans</div></div>
      <div class="rsa-ix-stat"><div class="num">200</div><div class="lbl">Doctors</div></div>
      <div class="rsa-ix-stat"><div class="num">412</div><div class="lbl">Providers</div></div>
      ...
      <div class="rsa-ix-stat"><div class="num">285</div><div class="lbl">ZIP Codes</div></div>
    </div>

    <div class="rsa-ix-intro">
      Medicare plan options in Utah vary by county and ZIP code. Whether you live in Salt Lake City, St. George, or a rural community, your location determines which plans are available and which providers are in-network. Use the resources below to find the right coverage where you live.
    </div>

    <div class="rsa-ix-section-label">Explore Medicare in Utah</div>
    <div class="rsa-ix-topic-grid">
      <div class="rsa-ix-topic-card">
        <h3>Medicare Plans</h3>
        <div class="count">73 plans available in Utah</div>
        <a class="btn" href="https://www.restingsycamore.com/medicare/plans/utah">View Plans in Utah →</a>
      </div>
      <div class="rsa-ix-topic-card">
        <h3>Doctors</h3>
        <div class="count">200 Medicare doctors in Utah</div>
        <a class="btn" href="https://www.restingsycamore.com/medicare/doctors/utah">Find Doctors in Utah →</a>
      </div>
      <div class="rsa-ix-topic-card">
        <h3>Care Facilities</h3>
        <div class="count">412 providers across Utah</div>
        <a class="btn" href="https://www.restingsycamore.com/medicare/providers/utah">View Providers in Utah →</a>
      </div>
      <div class="rsa-ix-topic-card">
        <h3>Cities</h3>
        <div class="count">100 cities with local data</div>
        <a class="btn" href="https://www.restingsycamore.com/medicare/states/utah/cities">Browse Cities in Utah →</a>
      </div>
      <div class="rsa-ix-topic-card">
        <h3>Counties</h3>
        <div class="count">29 Utah counties</div>
        <a class="btn" href="https://www.restingsycamore.com/medicare/states/utah/counties">Browse Counties in Utah →</a>
      </div>
      <div class="rsa-ix-topic-card">
        <h3>ZIP Codes</h3>
        <div class="count">285 ZIP codes with plan data</div>
        <a class="btn" href="https://www.restingsycamore.com/medicare/states/utah/zip-codes">Browse ZIPs in Utah →</a>
      </div>
    </div>

    <div class="rsa-ix-section-label">Medicare Carriers in Utah</div>
    <div class="rsa-ix-carrier-grid">
      ...
      <div class="rsa-ix-carrier-card">
        <div class="carrier-name">Regence BlueCross BlueShield</div>
        <a href="https://www.restingsycamore.com/medicare/carriers/regence-bluecross-blueshield">View Regence Plans →</a>
      </div>
      <div class="rsa-ix-carrier-card">
        <div class="carrier-name">SelectHealth</div>
        <a href="https://www.restingsycamore.com/medicare/carriers/selecthealth">View SelectHealth Plans →</a>
      </div>
      <div class="rsa-ix-carrier-card">
      ...
      <div class="rsa-ix-carrier-card">
        <div class="carrier-name">AARP / UnitedHealthcare</div>
        <a href="https://www.restingsycamore.com/medicare/carriers/aarp-unitedhealthcare">View AARP Plans →</a>
      </div>
    </div>

    <div class="rsa-ix-related">
      <a href="https://www.restingsycamore.com/medicare/states/ohio">Ohio</a>
