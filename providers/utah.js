...
.rsa-ix-plantype-card a { font-size: 13px; color: #2563eb; text-decoration: none; font-weight: 600; }`;
  ...
  el.innerHTML = `<div class="rsa-ix-wrap"><div class="rsa-ix-hero"><div class="rsa-ix-breadcrumb"><a href="https://www.restingsycamore.com">Home</a> <span>›</span> <a href="https://www.restingsycamore.com/medicare">Medicare</a> <span>›</span> <a href="https://www.restingsycamore.com/medicare/providers">Providers</a> <span>›</span> <span class="rsa-ix-bc-current">Utah</span></div><h1>Medicare Care Facilities in Utah</h1><p>54 Medicare-certified skilled nursing and care facilities in Utah.</p></div><div class="rsa-ix-content">
  <div class="rsa-ix-stats">
    <div class="rsa-ix-stat"><div class="num">54</div><div class="lbl">Facilities</div></div>
  </div>
  ...
  <div class="rsa-ix-section-title">All Utah Medicare Care Facilities — A to Z</div>
        ...
        <div class="rsa-ix-letter-group">
          ...
          <div class="rsa-ix-alpha-grid"><div class="rsa-ix-link-item"><a href="https://www.restingsycamore.com/medicare/providers/bella-terra-st-george-provider-ut">Bella Terra St George</a></div></div>
        </div>
        <div class="rsa-ix-letter-group">
        ...
        <div class="rsa-ix-letter-group">
          ...
          <div class="rsa-ix-alpha-grid"><div class="rsa-ix-link-item"><a href="https://www.restingsycamore.com/medicare/providers/fairfield-village-rehabilitation-provider-ut">Fairfield Village Rehabilitation</a></div></div>
        </div>
        <div class="rsa-ix-letter-group">
          <div class="rsa-ix-letter-heading">G</div>
          <div class="rsa-ix-alpha-grid"><div class="rsa-ix-link-item"><a href="https://www.restingsycamore.com/medicare/providers/george-e-wahlen-ogden-veterans-home-provider-ut">George E Wahlen Ogden Veterans Home</a></div></div>
        </div>
        <div class="rsa-ix-letter-group">
        ...
        <div class="rsa-ix-letter-group">
          ...
          <div class="rsa-ix-alpha-grid"><div class="rsa-ix-link-item"><a href="https://www.restingsycamore.com/medicare/providers/orem-rehabilitation-and-nursing-center-provider-ut">Orem Rehabilitation And Nursing Center</a></div></div>
        </div>
        <div class="rsa-ix-letter-group">
        ...
        <div class="rsa-ix-letter-group">
          ...
          <div class="rsa-ix-alpha-grid"><div class="rsa-ix-link-item"><a href="https://www.restingsycamore.com/medicare/providers/the-terrace-transitional-provider-ut">The Terrace Transitional</a></div></div>
        </div>
        <div class="rsa-ix-letter-group">
          <div class="rsa-ix-letter-heading">W</div>
          <div class="rsa-ix-alpha-grid"><div class="rsa-ix-link-item"><a href="https://www.restingsycamore.com/medicare/providers/william-e-christofferson-salt-lake-veterans-home-provider-ut">William E Christofferson Salt Lake Veterans Home</a></div></div>
        </div>
