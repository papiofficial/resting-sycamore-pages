(function(){
  var el = document.getElementById('rsa-providers-index');
  if (!el) return;
...
@media(max-width:640px){
  ...
  el.innerHTML = `<div class="rsa-ix-wrap"><div class="rsa-ix-header"><h1>Medicare Care Facilities Directory</h1><p>Browse 388 Medicare-covered care facilities across Ohio, Pennsylvania, and Utah — including skilled nursing facilities, rehabilitation centers, and long-term care.</p></div><div class="rsa-ix-container">
  <div class="rsa-ix-intro">
    <strong>Medicare covers short-term care in skilled nursing facilities</strong> — but only under specific conditions,
    and only at facilities that are Medicare-certified. If you or a family member needs post-hospital care,
    finding a Medicare-certified facility nearby matters a lot. Browse by state below.
  </div>

  <div class="rsa-ix-section-title">Browse by State</div>
  <div class="rsa-ix-state-cards">
        <a class="rsa-ix-state-card" href="https://www.restingsycamore.com/medicare/providers/ohio">
            <div class="count">167</div>
            <div class="label">Care Facilities in Ohio</div>
            <div class="sub">Skilled nursing, rehab, and long-term care →</div>
        </a>
        <a class="rsa-ix-state-card" href="https://www.restingsycamore.com/medicare/providers/pennsylvania">
            <div class="count">167</div>
            <div class="label">Care Facilities in Pennsylvania</div>
            <div class="sub">Skilled nursing, rehab, and long-term care →</div>
        </a>
        <a class="rsa-ix-state-card" href="https://www.restingsycamore.com/medicare/providers/utah">
            <div class="count">54</div>
            <div class="label">Care Facilities in Utah</div>
            <div class="sub">Skilled nursing, rehab, and long-term care →</div>
        </a></div>

  <div class="rsa-ix-related">
    <a href="https://www.restingsycamore.com/medicare/doctors">Doctors Directory</a>
    <a href="https://www.restingsycamore.com/medicare/specialties">Medical Specialties</a>
