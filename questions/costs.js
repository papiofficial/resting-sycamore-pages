...
@media(max-width:640px){
  ...
  el.innerHTML = `<div class="rsa-ix-wrap"><div class="page-header" style="background:#16a34a;">
  <h1>💰 Costs & Premiums</h1>
  <p class="tagline">Part A and B premiums, deductibles, IRMAA surcharges, and savings programs.</p>
</div>
