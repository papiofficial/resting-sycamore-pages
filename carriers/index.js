...
.rsa-ix-plantype-card a { font-size: 13px; color: #2563eb; text-decoration: none; font-weight: 600; }`;
  ...
  el.innerHTML = `<div class="rsa-ix-wrap"><div class="rsa-ix-hero"><div class="rsa-ix-breadcrumb"><a href="https://www.restingsycamore.com">Home</a> <span>›</span> <a href="https://www.restingsycamore.com/medicare">Medicare</a> <span>›</span> <span class="rsa-ix-bc-current">Carriers</span></div><h1>Medicare Insurance Carriers</h1><p>Compare Medicare insurance carriers offering plans in Utah, Ohio, and Pennsylvania.</p></div><div class="rsa-ix-content">
  <div class="rsa-ix-stats">
    <div class="rsa-ix-stat"><div class="num">35</div><div class="lbl">Carriers</div></div>
    <div class="rsa-ix-stat"><div class="num">8</div><div class="lbl">In Utah</div></div>
    <div class="rsa-ix-stat"><div class="num">20</div><div class="lbl">In Ohio</div></div>
    <div class="rsa-ix-stat"><div class="num">18</div><div class="lbl">In Pennsylvania</div></div>
  </div>
  ...
  <div class="rsa-ix-section-label">All 35 carriers — A to Z</div>
